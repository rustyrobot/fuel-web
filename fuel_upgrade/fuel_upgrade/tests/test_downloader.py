...
@patch('fuel_upgrade.downloader.download_file')
class TestDownloaderUnit(BaseTestCase):
    ...
    @patch('fuel_upgrade.downloader.calculate_free_space', return_value=101)
    @patch('fuel_upgrade.downloader.calculate_md5sum', return_value='')
    ...
    def test_run_error_in_case_if_disk_does_not_have_enough_space(self, _):
        ...
        with patch(
                'fuel_upgrade.downloader.calculate_free_space',
                return_value=1):
    ...
    def test_run_error_in_case_if_md5_sums_are_not_equal(
        ...
        with patch(
                'fuel_upgrade.downloader.calculate_md5sum',
